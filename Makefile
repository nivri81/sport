...
dev : compile
	...
	@$(ERL) -config sys.config -mnesia dir '"/tmp/mnesia/chunk_server_node1"' -pa _build/default/lib/*/ebin -pa _build/default/plugins/*/ebin -name chunk_server_node1@192.168.1.104 -setcookies cookie -s sync go -s storage_system
